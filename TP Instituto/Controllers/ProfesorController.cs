...
namespace TP_Instituto.Controllers
{
    public class ProfesorController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Legajo,Nombre,Apellido,FecNac,DNI,Mail,Tel,Antig")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Legajo,Nombre,Apellido,FecNac,DNI,Mail,Tel,Antig")] Profesor profesor)
        {
            if (ModelState.IsValid)
            {
